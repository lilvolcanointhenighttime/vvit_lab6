...
class Calculator(QWidget):
    def __init__(self):
        ...
        # self.b_tochka = QPushButton(".", self)
        # self.hbox_second.addWidget(self.b_tochka)
        ...
        # self.b_tochka.clicked.connect(lambda: self._button("."))
        self.num_1 = 0
        self.num_2 = 0
    ...
    def _result(self):
        ...
        if self.op == "+":
            ...
            self.input.setText(str(self.num_1 / self.num_2))
        # elif self.op == ".":
        #     self.input.setText(str(float(self.num_2)))
